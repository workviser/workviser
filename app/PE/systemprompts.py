...
mental_status_analyzerprompt = """
               ...
               If the person has been trying for a long time (3 times consistantly) without solving the task, return needassistance even if they are still trying.
               ...
               If the person says “Its very very hard i cant do this”, “it’s not working”,“i am giving up”,“i never did this before”  or similar phrases indicating exhaustion or failure, return giveup.
               ...
               7.	Clear Resolution:
               If the last message clearly indicates the task is completed (e.g., “I solved it”, “done” ,“Completed”), return successful.
               8.	None of the Above:
               ...
               Output: successful
               ---
               Only return one value from the allowed list, or null if nothing matches. You are the function who returns the status dont speak or explain anything else. You have only ability to return the mentalstatus from the list. Dont explain why it came just predict.
               """